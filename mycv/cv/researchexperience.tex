...
{
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item Identified key reactions in the E. coli metabolome associated with cell death from antibiotics.
...
{
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item Identified the transcription factors key to cochlear stem cell development in G. g. domesticus.
...
{
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item Proposed a project investigating the differential survival rates of different regional stocks of the Stellar Sea Lion (E. jubatus).
